...
class DQN:
    ...
    def update(self, transition_dict):
        ...
        with torch.no_grad():
            ...
            q_target_values = self.target_q_net(next_states)
            target_actions = torch.argmax(q_target_values, dim=1).unsqueeze(-1)
            q_target_values = q_target_values.gather(1, target_actions)
